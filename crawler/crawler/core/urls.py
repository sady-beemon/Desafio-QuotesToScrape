...
urlpatterns = [
    ...
    path('home/movies/edit/<int:pk>/', views.movies_edit, name = 'movies_edit'),
    path('home/movies/delete/<int:pk>/', views.movies_delete, name = 'movies_delete'),
    ...
    path('home/quotes/edit/<int:pk>/', views.quotes_edit, name = 'quotes_edit'),
    path('home/quotes/delete/<int:pk>/', views.quotes_delete, name = 'quotes_delete'),
